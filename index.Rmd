...
To see the implementation of the hierarchical bootstrap presented in class, see this [bootstrap tutorial](https://psyarxiv.com/h8ft7/), and the associated notebook `2depgps.Rmd`. For an implementation without loops, see this more elaborate [example](https://www.r-bloggers.com/resampling-hierarchically-structured-data-recursively/). 
