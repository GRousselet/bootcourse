...
- Perform group comparisons only after combining data across the 4 classes. Choose carefully 2 approaches based on everything you have learnt so far. Justify your choices, embed the results in text format using inline code ``r <code>``, and conclude succinctly but carefully.
